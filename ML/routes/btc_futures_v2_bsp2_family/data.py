...
ROUTE_NAME = "btc_futures_v2_bsp2_family"
SYMBOL = "BTCUSDT"
TRAIN_SYMBOLS = (
    "BTCUSDT",
    "ETHUSDT",
...
DEFAULT_DATASET_PATH = Path("data/btc_futures_v2_bsp2_family/btc_futures_v2_bsp2_family_dataset.parquet")
DEFAULT_MODEL_DIR = Path("result/ml/btc_futures_v2_bsp2_family")
DEFAULT_BACKTEST_DIR = Path("result/btc_futures_v2_bsp2_family")
