...
DEFAULT_POST_DATASET_PATH = Path("data/btc_futures_v1/btc_futures_v1_post_lifecycle.parquet")
...
DEFAULT_L3_DATASET_PATH = Path("data/btc_futures_v1/btc_futures_v1_l3_hold_snapshots.parquet")
...
def build_post_management_dataset(
    trades_path: str | Path = "result/btc_futures_v1/executed_trades.csv",
...
def train_l3_hold_models(
    ...
    *,
    ...
    metrics: dict[str, Any] = {"route": "btc_futures_v1", "model": "l3_hold", "rows": int(len(data)), "sides": {}}
...
def main() -> None:
    ...
    parser.add_argument("--trades", default="result/btc_futures_v1/executed_trades.csv")
