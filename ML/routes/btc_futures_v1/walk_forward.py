...
DEFAULT_WALK_FORWARD_MODEL_ROOT = Path("result/ml/btc_futures_v1_wf_validlabel_tier_sizing_a_boost")
DEFAULT_WALK_FORWARD_OUTPUT_ROOT = Path("result/btc_futures_v1_wf_validlabel_tier_sizing_a_boost")
...
def run_yearly_walk_forward(
    ...
    primary_label_column: str = "label_bsp2_valid",
    initial_cash: float = 100000.0,
    stake_fraction: float = 1.0,
    exit_mode: str = "third_then_opposite_bsp",
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Run yearly walk-forward validation for BTC futures v1")
    ...
    parser.add_argument("--min-daily-trades", type=float, default=0.20)
    ...
    parser.add_argument("--primary-label-column", default="label_bsp2_valid")
    parser.add_argument("--initial-cash", type=float, default=100000.0)
    parser.add_argument("--stake-fraction", type=float, default=1.0)
    parser.add_argument(
        "--exit-mode",
        default="third_then_opposite_bsp",
        choices=["post_management", "fixed_label", "structure_target", "opposite_bsp", "third_then_opposite_bsp", "third_then_opposite_no_after_timeout"],
    )
